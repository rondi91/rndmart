                        ...
                        <?php endif; ?>
                            ...
                            <div class="p-action-button">
                              <?php if($item->item_type != 'affiliate'): ?>
                                ...
                                <?php else: ?>
                                    <button class="btn btn-primary m-0"><i class="icon-bag"></i><span><?php echo e(__('Out oof stock')); ?></span></button>
                                <?php endif; ?>
                              <?php else: ?>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rndmart1\core\resources\views/front/catalog/product.blade.php ENDPATH**/ ?>